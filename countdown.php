...
<html>
  <head>
    <title>Countdown to ... <?php if(isset($_GET['title'])){
echo $_GET['title'];}else;?></title>
    <!-- Styles -->
  ...
  <body>
	<div class="container">
	<!-- Header-->
    <h1 style="" id="topheader">Countdown to <span class="editable" style="font-family: 'Kristi', cursive;"><?php if(isset($_GET['title'])){
echo $_GET['title'];}else{echo "[...]";};?></span></h1>
	<!--Countdown1-->
	<h2 style="font-family: 'Kristi', cursive; text-align:center;"><span id="countingto" class="daterender"><?php if(isset($_GET['start'])){
echo $_GET['start'];}else{echo "Date";};?></span> <a href="#" id="todatepicker" data-date-format="yyyy-mm-dd" data-date="<?php if(isset($_GET['start'])){
echo $_GET['start'];}else{echo date("Y-m-d");};?>"><i class="icon-calendar"></i></a></h2>
	<div class="row">
	<?php if(isset($_GET['start'])){ 
echo "<script>\$(document).ready(function () {\$('#countdownto').countdown({until: new Date('".$_GET['start']."'), format: 'wdHM'})});</script><div id='countdownto' class='well span8 offset2'>";
}
else{ 
print	"<div id='countdownto' class='well span8 offset2'><span class='countdown_row countdown_show4'><span class='countdown_section'><span class='countdown_amount'>--</span><br>Week</span><span class='countdown_section'><span class='countdown_amount'>--</span><br>Days</span><span class='countdown_section'><span class='countdown_amount'>--</span><br>Hours</span><span class='countdown_section'><span class='countdown_amount'>--</span><br>Minutes</span></span>";
};?>
	</div></div>
	<!--Countdown 2-->
	<h1 style="font-family: 'Arbutus Slab', serif; text-align:center" id="timefrom">Time From <span id="countingfrom" style="font-family: 'Kristi', cursive;" class="daterender"><?php if(isset($_GET['end'])){
echo $_GET['end'];}else{echo "Date";};?>Date </span> <a href="#" id="fromdatepicker" data-date-format="yyyy-mm-dd" data-date="<?php if(isset($_GET['end'])){
echo $_GET['end'];}else{echo date("Y-m-d");};?>"><i class="icon-calendar"></i></a></h1>
	<div class="row">
	<div id="countdownfrom" class="well span8 offset2">
	<span class="countdown_row countdown_show4"><span class="countdown_section"><span class="countdown_amount">--</span><br>Week</span><span class="countdown_section"><span class="countdown_amount">--</span><br>Days</span><span class="countdown_section"><span class="countdown_amount">--</span><br>Hours</span><span class="countdown_section"><span class="countdown_amount">--</span><br>Minutes</span></span>
	</div></div>
	<!--Progress Bar-->
	<div class="row" id="progressbar"><div class="span1 progresslabel">Start</div><div id="progressbarcontainer" class="progress span10"><!--<div class="bar" style="width: 0%;"></div>--></div><div class="span1 progresslabel">End</div></div>
	<!--Presets Row-->
	<hr>
